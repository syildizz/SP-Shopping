...
) : Controller
{
    ...
    public async Task<IActionResult> Adminize(string id)
    {
        ...
        _messageHandler.Add(TempData, new Message { Type = Message.MessageType.Success, Content = "Succesfully adminized" });
    ...
    public async Task<IActionResult> Unadminize(string id)
    {
        ...
        _messageHandler.Add(TempData, new Message { Type = Message.MessageType.Success, Content = "Succesfully unadminized" });
        return RedirectToAction(nameof(Index), new { id });
    }
